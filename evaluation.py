...
def get_cls_db(db_name):
    ...
    if db_name.lower() == 'cls_davis':
        return './intermolecular dataset/classification/DAVIS'
    elif db_name.lower() == 'cls_biosnap':
        return './intermolecular dataset/classification/BIOSNAP/full_data'
...
parser.add_argument('--dataset', choices=['cls_davis', 'cls_biosnap', 'cls_bindingdb'], default='cls_bindingdb',
...
flags.DEFINE_integer('hidden2', 512, 'Number of units in hidden layer 2.')
flags.DEFINE_integer('hidden3', 512, 'Number of units in hidden layer 3.')
...
drug_drug_sim_interaction_path = 'attribute dataset/H_Net/sim_network/Sim_mat_drug_drug.txt'
drug_drug_sim_se_path = 'attribute dataset/H_Net/sim_network/Sim_mat_drug_se.txt'
drug_drug_sim_disease_path = 'attribute dataset/H_Net/sim_network/Sim_mat_drug_disease.txt'
drug_protein_path = 'attribute dataset/H_Net/sevenNets/mat_drug_protein.txt'

# About Protein
protein_drug_path = 'attribute dataset/H_Net/sevenNets/mat_protein_drug.txt'
protein_protein_path = 'attribute dataset/H_Net/sevenNets/mat_protein_protein.txt'
protein_protein_sim_sequence_path = 'attribute dataset/H_Net/sim_network/Sim_mat_Proteins.txt'
protein_protein_sim_disease_path = 'attribute dataset/H_Net/sim_network/Sim_mat_protein_disease.txt'
protein_protein_sim_interaction_path = 'attribute dataset/H_Net/sim_network/Sim_mat_protein_protein.txt'

# About drug and protein (others)...
protein_disease_path = 'attribute dataset/H_Net/sevenNets/mat_protein_disease.txt'
drug_disease_path = 'attribute dataset/H_Net/sevenNets/mat_drug_disease.txt'
drug_sideEffect_path = 'attribute dataset/H_Net/sevenNets/mat_drug_se.txt'
