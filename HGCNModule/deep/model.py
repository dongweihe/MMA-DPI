...
from .layers import GraphConvolutionMulti, GraphConvolutionSparseMulti, \
    DistMultDecoder, FCNNOpreationDecoder, DEDICOMDecoder, BilinearDecoder
...
class HGCNModel(Model):
    ...
    def _build(self):
        ...
        for i, j in self.edge_types:
            ...
            if decoder == 'FCNNOpreation':
                self.edge_type2decoder[i, j] = FCNNOpreationDecoder(
